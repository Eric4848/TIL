 ...
 * @public
 */
export declare function AudioTrack({ trackRef, onSubscriptionStatusChanged, volume, ...props }: AudioTrackProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function AudioVisualizer({ trackRef, ...props }: AudioVisualizerProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function FocusToggle({ trackRef, ...props }: FocusToggleProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ParticipantAudioTile({ children, disableSpeakingIndicator, onParticipantClick, trackRef, ...htmlProps }: ParticipantTileProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ParticipantTile({ trackRef, children, onParticipantClick, disableSpeakingIndicator, ...htmlProps }: ParticipantTileProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function TrackMutedIndicator({ trackRef, show, ...props }: TrackMutedIndicatorProps): React_2.JSX.Element | null;
 ...
 * @public
 */
export declare function VideoTrack({ onTrackClick, onClick, onSubscriptionStatusChanged, trackRef, manageSubscription, ...props }: VideoTrackProps): React_2.JSX.Element;
