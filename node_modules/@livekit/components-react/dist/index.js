...
__export(src_exports, {
  ...
  isTrackReference: () => import_components_core58.isTrackReference,
  setLogExtension: () => import_components_core58.setLogExtension,
  setLogLevel: () => import_components_core58.setLogLevel,
...
function useRoomInfo(options = {}) {
  const room = useEnsureRoom(options.room);
  const infoObserver = React32.useMemo(() => (0, import_components_core23.roomInfoObserver)(room), [room]);
...
function useSpeakingParticipants() {
  const room = useRoomContext();
  const speakerObserver = React33.useMemo(() => (0, import_components_core24.activeSpeakerObserver)(room), [room]);
...
function useChatToggle({ props }) {
  ...
  const { className } = React38.useMemo(() => (0, import_components_core28.setupChatToggle)(), []);
...
function useTrackRefBySourceOrName(source) {
  var _a, _b;
  const [publication, setPublication] = React43.useState((0, import_components_core33.getTrackByIdentifier)(source));
  const { trackObserver } = React43.useMemo(() => {
  ...
  return {
    ...
    source: (_b = source.source) != null ? _b : import_livekit_client6.Track.Source.Unknown,
    publication
  };
}
...
function cloneSingleChild(children, props, key) {
  return React73.Children.map(children, (child) => {
    if (React73.isValidElement(child) && React73.Children.only(children)) {
      return React73.cloneElement(child, __spreadProps(__spreadValues({}, props), { key }));
    }
    return child;
  });
}
...
function MediaDeviceSelect(_a) {
  ...
  return /* @__PURE__ */ React74.createElement("ul", __spreadValues({}, mergedProps), devices.map((device, index) => /* @__PURE__ */ React74.createElement(
    "li",
    {
      key: device.deviceId,
      id: device.deviceId,
    ...
    /* @__PURE__ */ React74.createElement("button", { className: "lk-button", onClick: () => handleActiveDeviceChange(device.deviceId) }, device.label)
  )));
}
...
function StartAudio(_a) {
  ...
  return /* @__PURE__ */ React75.createElement("button", __spreadValues({}, mergedProps), label);
}
...
function getSourceIcon(source, enabled) {
  switch (source) {
    case import_livekit_client10.Track.Source.Microphone:
      return enabled ? /* @__PURE__ */ React76.createElement(MicIcon_default, null) : /* @__PURE__ */ React76.createElement(MicDisabledIcon_default, null);
    case import_livekit_client10.Track.Source.Camera:
      return enabled ? /* @__PURE__ */ React76.createElement(CameraIcon_default, null) : /* @__PURE__ */ React76.createElement(CameraDisabledIcon_default, null);
    case import_livekit_client10.Track.Source.ScreenShare:
      return enabled ? /* @__PURE__ */ React76.createElement(ScreenShareStopIcon_default, null) : /* @__PURE__ */ React76.createElement(ScreenShareIcon_default, null);
    default:
      return void 0;
  }
}
function getConnectionQualityIcon(quality) {
  switch (quality) {
    case import_livekit_client10.ConnectionQuality.Excellent:
      return /* @__PURE__ */ React76.createElement(QualityExcellentIcon_default, null);
    case import_livekit_client10.ConnectionQuality.Good:
      return /* @__PURE__ */ React76.createElement(QualityGoodIcon_default, null);
    case import_livekit_client10.ConnectionQuality.Poor:
      return /* @__PURE__ */ React76.createElement(QualityPoorIcon_default, null);
    default:
      return /* @__PURE__ */ React76.createElement(QualityUnknownIcon_default, null);
  }
}
...
function TrackToggle(_a) {
  ...
  return /* @__PURE__ */ React77.createElement("button", __spreadValues({}, buttonProps), (showIcon != null ? showIcon : true) && getSourceIcon(props.source, enabled), props.children);
}
...
function ConnectionQualityIndicator(props) {
  ...
  return /* @__PURE__ */ React78.createElement("div", __spreadValues({}, elementProps), (_a = props.children) != null ? _a : getConnectionQualityIcon(quality));
}
...
function ParticipantName(_a) {
  ...
  const p = useEnsureParticipant(participant);
  const { className, infoObserver } = React79.useMemo(() => {
  ...
  return /* @__PURE__ */ React79.createElement("span", __spreadValues({}, mergedProps), name !== "" ? name : identity, props.children);
}
...
function TrackMutedIndicator(_a) {
  ...
  const htmlProps = React80.useMemo(
    () => mergeProps2(props, {
      className
    }),
    [className, props]
  ...
  return /* @__PURE__ */ React80.createElement("div", __spreadProps(__spreadValues({}, htmlProps), { "data-lk-muted": isMuted }), (_a2 = props.children) != null ? _a2 : getSourceIcon(trackRef.source, !isMuted));
}

// src/assets/images/ParticipantPlaceholder.tsx
var React81 = __toESM(require("react"));
var SvgParticipantPlaceholder = (props) => /* @__PURE__ */ React81.createElement(
  "svg",
  __spreadValues({
    width: 320,
    height: 320,
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a;
  const [publication, setPublication] = React82.useState((0, import_components_core42.getTrackByIdentifier)(observerOptions));
  const [isMuted, setMuted] = React82.useState(publication == null ? void 0 : publication.isMuted);
  const [isSubscribed, setSubscribed] = React82.useState(publication == null ? void 0 : publication.isSubscribed);
  const [track, setTrack] = React82.useState(publication == null ? void 0 : publication.track);
  const [orientation, setOrientation] = React82.useState("landscape");
  const previousElement = React82.useRef();
  const { className, trackObserver } = React82.useMemo(() => {
  ...
  React82.useEffect(() => {
    ...
    if (track) {
      ...
      if (((_a2 = options.element) == null ? void 0 : _a2.current) && !((0, import_components_core42.isLocal)(observerOptions.participant) && (track == null ? void 0 : track.kind) === "audio")) {
...
function VideoTrack(_a) {
  ...
  const trackReference = useEnsureTrackRef(trackRef);
  const mediaEl = React83.useRef(null);
  ...
  return /* @__PURE__ */ React83.createElement("video", __spreadProps(__spreadValues({ ref: mediaEl }, elementProps), { muted: true, onClick: clickHandler }));
}
...
function AudioTrack(_a) {
  ...
  const trackReference = useEnsureTrackRef(trackRef);
  const mediaEl = React84.useRef(null);
  const {
    elementProps,
    isSubscribed,
    track,
  ...
  return /* @__PURE__ */ React84.createElement("audio", __spreadValues({ ref: mediaEl }, elementProps));
}

// src/components/participant/ParticipantTile.tsx
function ParticipantContextIfNeeded(props) {
  const hasContext = !!useMaybeParticipantContext();
  return props.participant && !hasContext ? /* @__PURE__ */ React85.createElement(ParticipantContext.Provider, { value: props.participant }, props.children) : /* @__PURE__ */ React85.createElement(React85.Fragment, null, props.children);
}
function TrackRefContextIfNeeded(props) {
  const hasContext = !!useMaybeTrackRefContext();
  return props.trackRef && !hasContext ? /* @__PURE__ */ React85.createElement(TrackRefContext.Provider, { value: props.trackRef }, props.children) : /* @__PURE__ */ React85.createElement(React85.Fragment, null, props.children);
}
function ParticipantTile(_a) {
  ...
  const handleSubscribe = React85.useCallback(
    (subscribed) => {
  ...
  return /* @__PURE__ */ React85.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React85.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React85.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React85.createElement(React85.Fragment, null, (0, import_components_core44.isTrackReference)(trackReference) && (((_b2 = trackReference.publication) == null ? void 0 : _b2.kind) === "video" || trackReference.source === import_livekit_client13.Track.Source.Camera || trackReference.source === import_livekit_client13.Track.Source.ScreenShare) ? /* @__PURE__ */ React85.createElement(
    VideoTrack,
    {
      trackRef: trackReference,
  ...
  ) : (0, import_components_core44.isTrackReference)(trackReference) && /* @__PURE__ */ React85.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React85.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === import_livekit_client13.Track.Source.Camera ? /* @__PURE__ */ React85.createElement(React85.Fragment, null, isEncrypted && /* @__PURE__ */ React85.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React85.createElement(
    TrackMutedIndicator,
    {
      trackRef: {
  ...
  ), /* @__PURE__ */ React85.createElement(ParticipantName, null)) : /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(ScreenShareIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React85.createElement(ParticipantName, null, "'s screen"))), /* @__PURE__ */ React85.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" }))), /* @__PURE__ */ React85.createElement(FocusToggle, { trackRef: trackReference }))));
}

// src/components/layout/FocusLayout.tsx
function FocusLayoutContainer(props) {
  const elementProps = mergeProps2(props, { className: "lk-focus-layout" });
  return /* @__PURE__ */ React86.createElement("div", __spreadValues({}, elementProps), props.children);
}
function FocusLayout(_a) {
  var _b = _a, { trackRef } = _b, htmlProps = __objRest(_b, ["trackRef"]);
  return /* @__PURE__ */ React86.createElement(ParticipantTile, __spreadValues({ trackRef }, htmlProps));
}
...
function TrackLoop(_a) {
  ...
  return /* @__PURE__ */ React87.createElement(React87.Fragment, null, tracks.map((trackReference) => {
...
function PaginationControl({
  ...
  const [interactive, setInteractive] = React88.useState(false);
  React88.useEffect(() => {
    let subscription;
    if (connectedElement) {
  ...
  return /* @__PURE__ */ React88.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": interactive }, /* @__PURE__ */ React88.createElement("button", { className: "lk-button", onClick: prevPage }, /* @__PURE__ */ React88.createElement(Chevron_default, null)), /* @__PURE__ */ React88.createElement("span", { className: "lk-pagination-count" }, `${currentPage} of ${totalPageCount}`), /* @__PURE__ */ React88.createElement("button", { className: "lk-button", onClick: nextPage }, /* @__PURE__ */ React88.createElement(Chevron_default, null)));
}
...
function PaginationIndicator({ totalPageCount, currentPage }) {
  const bubbles = new Array(totalPageCount).fill("").map((_, index) => {
    if (index + 1 === currentPage) {
      return /* @__PURE__ */ React89.createElement("span", { "data-lk-active": true, key: index });
    } else {
      return /* @__PURE__ */ React89.createElement("span", { key: index });
    }
  });
  return /* @__PURE__ */ React89.createElement("div", { className: "lk-pagination-indicator" }, bubbles);
}

// src/components/layout/GridLayout.tsx
function GridLayout(_a) {
  var _b = _a, { tracks } = _b, props = __objRest(_b, ["tracks"]);
  const gridEl = React90.createRef();
  ...
  return /* @__PURE__ */ React90.createElement("div", __spreadValues({ ref: gridEl, "data-lk-pagination": pagination.totalPageCount > 1 }, elementProps), /* @__PURE__ */ React90.createElement(TrackLoop, { tracks: pagination.tracks }, props.children), tracks.length > layout.maxTiles && /* @__PURE__ */ React90.createElement(React90.Fragment, null, /* @__PURE__ */ React90.createElement(
    PaginationIndicator,
    {
      totalPageCount: pagination.totalPageCount,
      currentPage: pagination.currentPage
    }
  ), /* @__PURE__ */ React90.createElement(PaginationControl, __spreadValues({ pagesContainer: gridEl }, pagination))));
}
...
function CarouselLayout(_a) {
  ...
  const asideEl = React91.useRef(null);
  const [prevTiles, setPrevTiles] = React91.useState(0);
  ...
  return /* @__PURE__ */ React91.createElement("aside", __spreadValues({ key: carouselOrientation, className: "lk-carousel", ref: asideEl }, props), /* @__PURE__ */ React91.createElement(TrackLoop, { tracks: sortedTiles }, props.children));
}
...
function LayoutContextProvider({
  ...
  React92.useEffect(() => {
    import_components_core48.log.debug("Widget Updated", { widgetState: layoutContextValue.widget.state });
    if (onWidgetChange && layoutContextValue.widget.state) {
      onWidgetChange(layoutContextValue.widget.state);
    }
  }, [onWidgetChange, layoutContextValue.widget.state]);
  return /* @__PURE__ */ React92.createElement(LayoutContext.Provider, { value: layoutContextValue }, children);
}
...
function LiveKitRoom(props) {
  ...
  return /* @__PURE__ */ React93.createElement("div", __spreadValues({}, htmlProps), room && /* @__PURE__ */ React93.createElement(RoomContext.Provider, { value: room }, /* @__PURE__ */ React93.createElement(LKFeatureContext.Provider, { value: props.featureFlags }, props.children)));
}
...
function AudioVisualizer(_a) {
  ...
  return /* @__PURE__ */ React94.createElement(
    ...
    /* @__PURE__ */ React94.createElement("rect", { x: "0", y: "0", width: "100%", height: "100%" }),
    /* @__PURE__ */ React94.createElement(
      ...
      volumes.map((vol, idx) => /* @__PURE__ */ React94.createElement(
        "rect",
        {
          key: idx,
...
function ParticipantLoop(_a) {
  ...
  return /* @__PURE__ */ React95.createElement(React95.Fragment, null, participants.map((participant) => /* @__PURE__ */ React95.createElement(ParticipantContext.Provider, { value: participant, key: participant.identity }, cloneSingleChild(props.children))));
}
...
function RoomAudioRenderer({ volume, muted }) {
  ...
  ).filter((ref) => !(0, import_components_core49.isLocal)(ref.participant) && ref.publication.kind === import_livekit_client14.Track.Kind.Audio);
  React96.useEffect(() => {
    for (const track of tracks) {
      track.publication.setSubscribed(true);
    }
  }, [tracks]);
  return /* @__PURE__ */ React96.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React96.createElement(
    AudioTrack,
    {
...
function RoomName(_a) {
  ...
  return /* @__PURE__ */ React97.createElement("span", __spreadValues({}, htmlAttributes), childrenPosition === "before" && children, name, childrenPosition === "after" && children);
}

// src/components/Toast.tsx
var React98 = __toESM(require("react"));
function Toast(props) {
  const htmlProps = React98.useMemo(() => mergeProps2(props, { className: "lk-toast" }), [props]);
  return /* @__PURE__ */ React98.createElement("div", __spreadValues({}, htmlProps), props.children);
}
...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React99.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React99.createElement(TrackRefContext.Provider, { value: trackReference }, children != null ? children : /* @__PURE__ */ React99.createElement(React99.Fragment, null, (0, import_components_core50.isTrackReference)(trackReference) && /* @__PURE__ */ React99.createElement(AudioTrack, { trackRef: trackReference }), /* @__PURE__ */ React99.createElement(AudioVisualizer, null), /* @__PURE__ */ React99.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React99.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React99.createElement(TrackMutedIndicator, { trackRef: trackReference }), /* @__PURE__ */ React99.createElement(ParticipantName, null)), /* @__PURE__ */ React99.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
function ConnectionStateToast(props) {
  const [notification, setNotification] = React100.useState(void 0);
  const state = useConnectionState(props.room);
  React100.useEffect(() => {
    switch (state) {
      case import_livekit_client15.ConnectionState.Reconnecting:
        setNotification(
          /* @__PURE__ */ React100.createElement(React100.Fragment, null, /* @__PURE__ */ React100.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Reconnecting")
        );
        break;
      case import_livekit_client15.ConnectionState.Connecting:
        setNotification(
          /* @__PURE__ */ React100.createElement(React100.Fragment, null, /* @__PURE__ */ React100.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Connecting")
        );
        break;
      case import_livekit_client15.ConnectionState.Disconnected:
        setNotification(/* @__PURE__ */ React100.createElement(React100.Fragment, null, "Disconnected"));
        break;
      default:
  ...
  return notification ? /* @__PURE__ */ React100.createElement(Toast, { className: "lk-toast-connection-state" }, notification) : /* @__PURE__ */ React100.createElement(React100.Fragment, null);
}
...
function ChatEntry(_a) {
  ...
  var _a2, _b2, _c, _d;
  const formattedMessage = React101.useMemo(() => {
  ...
  return /* @__PURE__ */ React101.createElement(
    ...
    (!hideTimestamp || !hideName || hasBeenEdited) && /* @__PURE__ */ React101.createElement("span", { className: "lk-meta-data" }, !hideName && /* @__PURE__ */ React101.createElement("strong", { className: "lk-participant-name" }, (_d = (_b2 = entry.from) == null ? void 0 : _b2.name) != null ? _d : (_c = entry.from) == null ? void 0 : _c.identity), (!hideTimestamp || hasBeenEdited) && /* @__PURE__ */ React101.createElement("span", { className: "lk-timestamp" }, hasBeenEdited && "edited ", time.toLocaleTimeString(locale, { timeStyle: "short" }))),
    /* @__PURE__ */ React101.createElement("span", { className: "lk-message-body" }, formattedMessage)
  );
}
function formatChatMessageLinks(message) {
  return (0, import_components_core51.tokenize)(message, (0, import_components_core51.createDefaultGrammar)()).map((tok, i) => {
    if (typeof tok === `string`) {
      return tok;
    } else {
      const content = tok.content.toString();
      const href = tok.type === `url` ? /^http(s?):\/\//.test(content) ? content : `https://${content}` : `mailto:${content}`;
      return /* @__PURE__ */ React101.createElement("a", { className: "lk-chat-link", key: i, href, target: "_blank", rel: "noreferrer" }, content);
    }
  });
}
...
function Chat(_a) {
  ...
  const chatOptions = React102.useMemo(() => {
    return { messageDecoder, messageEncoder, channelTopic };
  }, [messageDecoder, messageEncoder, channelTopic]);
  const { send, chatMessages, isSending } = useChat(chatOptions);
  const layoutContext = useMaybeLayoutContext();
  const lastReadMsgAt = React102.useRef(0);
  ...
  return /* @__PURE__ */ React102.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat" }), /* @__PURE__ */ React102.createElement("div", { className: "lk-chat-header" }, "Messages", /* @__PURE__ */ React102.createElement(ChatToggle, { className: "lk-close-button" }, /* @__PURE__ */ React102.createElement(ChatCloseIcon_default, null))), /* @__PURE__ */ React102.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, props.children ? chatMessages.map(
    (msg, idx) => {
      var _a2;
  ...
  })), /* @__PURE__ */ React102.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React102.createElement(
    "input",
    {
  ...
  ), /* @__PURE__ */ React102.createElement("button", { type: "submit", className: "lk-button lk-chat-form-button", disabled: isSending }, "Send")));
}
...
function MediaDeviceMenu(_a) {
  ...
  const [devices, setDevices] = React103.useState([]);
  ...
  React103.useLayoutEffect(() => {
    if (button.current && tooltip.current && (devices || updateRequired)) {
      (0, import_components_core52.computeMenuPosition)(button.current, tooltip.current).then(({ x, y }) => {
        if (tooltip.current) {
  ...
  return /* @__PURE__ */ React103.createElement(React103.Fragment, null, /* @__PURE__ */ React103.createElement(
    ...
    props.children
  ), !props.disabled && /* @__PURE__ */ React103.createElement(
    "div",
    {
    ...
    kind ? /* @__PURE__ */ React103.createElement(
      MediaDeviceSelect,
      {
        initialSelection,
    ...
    ) : /* @__PURE__ */ React103.createElement(React103.Fragment, null, /* @__PURE__ */ React103.createElement("div", { className: "lk-device-menu-heading" }, "Audio inputs"), /* @__PURE__ */ React103.createElement(
      MediaDeviceSelect,
      {
        kind: "audioinput",
    ...
    ), /* @__PURE__ */ React103.createElement("div", { className: "lk-device-menu-heading" }, "Video inputs"), /* @__PURE__ */ React103.createElement(
      MediaDeviceSelect,
      {
        kind: "videoinput",
...
function usePreviewTracks(options, onError) {
  const [tracks, setTracks] = React105.useState();
  React105.useEffect(() => {
...
function usePreviewDevice(enabled, deviceId, kind) {
  const [deviceError, setDeviceError] = React105.useState(null);
  const [isCreatingTrack, setIsCreatingTrack] = React105.useState(false);
  const devices = useMediaDevices({ kind });
  const [selectedDevice, setSelectedDevice] = React105.useState(
    void 0
  );
  const [localTrack, setLocalTrack] = React105.useState();
  const [localDeviceId, setLocalDeviceId] = React105.useState(deviceId);
  React105.useEffect(() => {
  ...
  const prevDeviceId = React105.useRef(localDeviceId);
  React105.useEffect(() => {
...
function PreJoin(_a) {
  ...
  const [userChoices, setUserChoices] = React105.useState(import_components_core55.defaultUserChoices);
  ...
  const [audioEnabled, setAudioEnabled] = React105.useState(initialUserChoices.audioEnabled);
  const [videoEnabled, setVideoEnabled] = React105.useState(initialUserChoices.videoEnabled);
  const [audioDeviceId, setAudioDeviceId] = React105.useState(
    initialUserChoices.audioDeviceId
  );
  const [videoDeviceId, setVideoDeviceId] = React105.useState(
    initialUserChoices.videoDeviceId
  );
  const [username, setUsername] = React105.useState(initialUserChoices.username);
  React105.useEffect(() => {
  ...
  const videoEl = React105.useRef(null);
  const videoTrack = React105.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client16.Track.Kind.Video)[0],
    [tracks]
  );
  const facingMode = React105.useMemo(() => {
    if (videoTrack) {
  ...
  const audioTrack = React105.useMemo(
  ...
  const [isValid, setIsValid] = React105.useState();
  const handleValidation = React105.useCallback(
    (values) => {
  ...
  return /* @__PURE__ */ React105.createElement("div", __spreadValues({ className: "lk-prejoin" }, htmlProps), /* @__PURE__ */ React105.createElement("div", { className: "lk-video-container" }, videoTrack && /* @__PURE__ */ React105.createElement("video", { ref: videoEl, width: "1280", height: "720", "data-lk-facing-mode": facingMode }), (!videoTrack || !videoEnabled) && /* @__PURE__ */ React105.createElement("div", { className: "lk-camera-off-note" }, /* @__PURE__ */ React105.createElement(ParticipantPlaceholder_default, null))), /* @__PURE__ */ React105.createElement("div", { className: "lk-button-group-container" }, /* @__PURE__ */ React105.createElement("div", { className: "lk-button-group audio" }, /* @__PURE__ */ React105.createElement(
    TrackToggle,
    {
  ...
  ))), /* @__PURE__ */ React105.createElement("div", { className: "lk-button-group video" }, /* @__PURE__ */ React105.createElement(
    TrackToggle,
    {
  ...
  )))), /* @__PURE__ */ React105.createElement("form", { className: "lk-username-container" }, /* @__PURE__ */ React105.createElement(
    "input",
    {
    ...
    joinLabel
  )), debug && /* @__PURE__ */ React105.createElement(React105.Fragment, null, /* @__PURE__ */ React105.createElement("strong", null, "User Choices:"), /* @__PURE__ */ React105.createElement("ul", { className: "lk-list", style: { overflow: "hidden", maxWidth: "15rem" } }, /* @__PURE__ */ React105.createElement("li", null, "Username: ", `${userChoices.username}`), /* @__PURE__ */ React105.createElement("li", null, "Video Enabled: ", `${userChoices.videoEnabled}`), /* @__PURE__ */ React105.createElement("li", null, "Audio Enabled: ", `${userChoices.audioEnabled}`), /* @__PURE__ */ React105.createElement("li", null, "Video Device: ", `${userChoices.videoDeviceId}`), /* @__PURE__ */ React105.createElement("li", null, "Audio Device: ", `${userChoices.audioDeviceId}`))));
}
...
function StartMediaButton(_a) {
  ...
  return /* @__PURE__ */ React106.createElement("button", __spreadValues({ style }, restProps), label != null ? label : `Start ${!canPlayAudio ? "Audio" : "Video"}`);
}
...
// src/components/controls/SettingsMenuToggle.tsx
function SettingsMenuToggle(props) {
  const { mergedProps } = useSettingsToggle({ props });
  return /* @__PURE__ */ React108.createElement("button", __spreadValues({}, mergedProps), props.children);
}
...
function ControlBar(_a) {
  ...
  const browserSupportsScreenSharing = (0, import_components_core56.supportsScreenSharing)();
  ...
  ), visibleControls.chat && /* @__PURE__ */ React109.createElement(ChatToggle, null, showIcon && /* @__PURE__ */ React109.createElement(ChatIcon_default, null), showText && "Chat"), visibleControls.settings && /* @__PURE__ */ React109.createElement(SettingsMenuToggle, null, showIcon && /* @__PURE__ */ React109.createElement(GearIcon_default, null), showText && "Settings"), visibleControls.leave && /* @__PURE__ */ React109.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React109.createElement(LeaveIcon_default, null), showText && "Leave"), /* @__PURE__ */ React109.createElement(StartMediaButton, null));
}
...
function VideoConference(_a) {
  ...
  var _a2, _b2;
  const [widgetState, setWidgetState] = React110.useState({
    showChat: false,
    unreadMessages: 0,
    showSettings: false
  });
  const lastAutoFocusedScreenShareTrack = React110.useRef(null);
  const tracks = useTracks(
    [
  ...
  const widgetUpdate = (state) => {
    import_components_core57.log.debug("updating widget state", state);
    setWidgetState(state);
  };
  const layoutContext = useCreateLayoutContext();
  const screenShareTracks = tracks.filter(import_components_core57.isTrackReference).filter((track) => track.publication.source === import_livekit_client18.Track.Source.ScreenShare);
  const focusTrack = (_a2 = usePinnedTracks(layoutContext)) == null ? void 0 : _a2[0];
  const carouselTracks = tracks.filter((track) => !(0, import_components_core57.isEqualTrackRef)(track, focusTrack));
  React110.useEffect(() => {
    var _a3, _b3, _c, _d;
    if (screenShareTracks.some((track) => track.publication.isSubscribed) && lastAutoFocusedScreenShareTrack.current === null) {
      import_components_core57.log.debug("Auto set screen share focus:", { newScreenShareTrack: screenShareTracks[0] });
      ...
      import_components_core57.log.debug("Auto clearing screen share focus.");
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React110.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core57.isWeb)() && /* @__PURE__ */ React110.createElement(
    LayoutContextProvider,
    {
      value: layoutContext,
      onWidgetChange: widgetUpdate
    },
    /* @__PURE__ */ React110.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React110.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React110.createElement(GridLayout, { tracks }, /* @__PURE__ */ React110.createElement(ParticipantTile, null))) : /* @__PURE__ */ React110.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React110.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React110.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React110.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React110.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React110.createElement(ControlBar, { controls: { chat: true, settings: !!SettingsComponent } })),
    ...
    SettingsComponent && /* @__PURE__ */ React110.createElement(
      "div",
      {
        className: "lk-settings-menu-modal",
        style: { display: widgetState.showSettings ? "block" : "none" }
      },
      /* @__PURE__ */ React110.createElement(SettingsComponent, null)
    )
  ), /* @__PURE__ */ React110.createElement(RoomAudioRenderer, null), /* @__PURE__ */ React110.createElement(ConnectionStateToast, null));
}
...
function AudioConference(_a) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React111.createElement(LayoutContextProvider, { onWidgetChange: setWidgetState }, /* @__PURE__ */ React111.createElement("div", __spreadValues({ className: "lk-audio-conference" }, props), /* @__PURE__ */ React111.createElement("div", { className: "lk-audio-conference-stage" }, /* @__PURE__ */ React111.createElement(TrackLoop, { tracks: audioTracks }, /* @__PURE__ */ React111.createElement(ParticipantAudioTile, null))), /* @__PURE__ */ React111.createElement(
    ControlBar,
    {
      controls: { microphone: true, screenShare: false, camera: false, chat: true }
    }
  ), widgetState.showChat && /* @__PURE__ */ React111.createElement(Chat, null)));
}
