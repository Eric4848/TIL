...
function useTrackToggle(_a) {
  ...
  const { toggle, className, pendingObserver, enabledObserver } = React31.useMemo(
    () => room ? (0, import_components_core21.setupMediaToggle)(source, room, captureOptions) : (0, import_components_core21.setupManualToggle)(),
...
function useIsEncrypted(participant) {
  ...
  const isEncrypted = useObservableState(
    observer,
    p instanceof import_livekit_client5.LocalParticipant ? p.isE2EEEnabled : p.isEncrypted
  );
  return isEncrypted;
}
...
var useMultibandTrackVolume = (trackOrTrackReference, options = {}) => {
  var _a;
  const track = trackOrTrackReference instanceof import_livekit_client6.Track ? trackOrTrackReference : (_a = trackOrTrackReference == null ? void 0 : trackOrTrackReference.publication) == null ? void 0 : _a.track;
  ...
  React35.useEffect(() => {
    ...
    const { analyser, cleanup } = (0, import_livekit_client6.createAudioAnalyser)(track, opts.analyserOptions);
...
function ChatToggle(props) {
  ...
  return /* @__PURE__ */ React36.createElement("button", __spreadValues({}, mergedProps), props.children);
}
...
function DisconnectButton(props) {
  ...
  return /* @__PURE__ */ React37.createElement("button", __spreadValues({}, buttonProps), props.children);
}
...
function MediaDeviceSelect(_a) {
  ...
  const handleError = React58.useCallback(
    (e) => {
      if (room) {
        room.emit(import_livekit_client7.RoomEvent.MediaDevicesError, e);
      }
...
function getSourceIcon(source, enabled) {
  switch (source) {
    case import_livekit_client8.Track.Source.Microphone:
    ...
    case import_livekit_client8.Track.Source.Camera:
    ...
    case import_livekit_client8.Track.Source.ScreenShare:
...
function getConnectionQualityIcon(quality) {
  switch (quality) {
    case import_livekit_client8.ConnectionQuality.Excellent:
      return /* @__PURE__ */ React59.createElement(QualityExcellentIcon_default, null);
    case import_livekit_client8.ConnectionQuality.Good:
      return /* @__PURE__ */ React59.createElement(QualityGoodIcon_default, null);
    case import_livekit_client8.ConnectionQuality.Poor:
...
function TrackMutedIndicator(_a) {
  ...
  return /* @__PURE__ */ React63.createElement("div", __spreadProps(__spreadValues({}, htmlProps), { "data-lk-muted": isMuted }), (_a2 = props.children) != null ? _a2 : getSourceIcon(trackRef.source, !isMuted));
}
...
function VideoTrack(_a) {
  ...
  React66.useEffect(() => {
    if (manageSubscription && trackReference.publication instanceof import_livekit_client9.RemoteTrackPublication && (debouncedIntersectionEntry == null ? void 0 : debouncedIntersectionEntry.isIntersecting) === false && (intersectionEntry == null ? void 0 : intersectionEntry.isIntersecting) === false) {
      trackReference.publication.setSubscribed(false);
    }
  }, [debouncedIntersectionEntry, trackReference, manageSubscription]);
  React66.useEffect(() => {
    if (manageSubscription && trackReference.publication instanceof import_livekit_client9.RemoteTrackPublication && (intersectionEntry == null ? void 0 : intersectionEntry.isIntersecting) === true) {
...
function AudioTrack(_a) {
  ...
  React67.useEffect(() => {
    ...
    if (track instanceof import_livekit_client10.RemoteAudioTrack) {
  ...
  React67.useEffect(() => {
    ...
    if (pub instanceof import_livekit_client10.RemoteTrackPublication) {
...
function PaginationIndicator({ totalPageCount, currentPage }) {
  ...
  return /* @__PURE__ */ React72.createElement("div", { className: "lk-pagination-indicator" }, bubbles);
}
...
function RoomAudioRenderer({ volume, muted }) {
  const tracks = useTracks(
    [import_livekit_client12.Track.Source.Microphone, import_livekit_client12.Track.Source.ScreenShareAudio, import_livekit_client12.Track.Source.Unknown],
    {
      updateOnlyOn: [],
      onlySubscribed: false
    }
  ).filter((ref) => !(0, import_components_core35.isLocal)(ref.participant) && ref.publication.kind === import_livekit_client12.Track.Kind.Audio);
  React77.useEffect(() => {
...
function usePreviewTracks(options, onError) {
  ...
  React84.useEffect(() => {
    ...
    if (options.audio || options.video) {
      trackPromise = (0, import_livekit_client14.createLocalTracks)(options);
...
function usePreviewDevice(enabled, deviceId, kind) {
  ...
  const createTrack = (deviceId2, kind2) => __async(this, null, function* () {
    try {
      const track = kind2 === "videoinput" ? yield (0, import_livekit_client14.createLocalVideoTrack)({
        deviceId: deviceId2,
        resolution: import_livekit_client14.VideoPresets.h720.resolution
      }) : yield (0, import_livekit_client14.createLocalAudioTrack)({ deviceId: deviceId2 });
...
function PreJoin(_a) {
  ...
  const videoTrack = React84.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client14.Track.Kind.Video)[0],
    [tracks]
  );
  const facingMode = React84.useMemo(() => {
    if (videoTrack) {
      const { facingMode: facingMode2 } = (0, import_livekit_client14.facingModeFromLocalTrack)(videoTrack);
      return facingMode2;
    } else {
      return "undefined";
    }
  ...
  const audioTrack = React84.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client14.Track.Kind.Audio)[0],
    [tracks]
  );
  React84.useEffect(() => {
...
function StartMediaButton(_a) {
  ...
  return /* @__PURE__ */ React85.createElement("button", __spreadValues({ style }, restProps), label != null ? label : `Start ${!canPlayAudio ? "Audio" : "Video"}`);
}
...
function ControlBar(_a) {
  ...
  return /* @__PURE__ */ React88.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React88.createElement(
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React88.createElement(TrackToggle, { source: import_livekit_client15.Track.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React88.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
    ...
    TrackToggle,
    {
      source: import_livekit_client15.Track.Source.ScreenShare,
...
function VideoConference(_a) {
  ...
  const tracks = useTracks(
    ...
    { updateOnlyOn: [import_livekit_client16.RoomEvent.ActiveSpeakersChanged], onlySubscribed: false }
  );
  ...
  const screenShareTracks = tracks.filter(import_components_core42.isTrackReference).filter((track) => track.publication.source === import_livekit_client16.Track.Source.ScreenShare);
...
function AudioConference(_a) {
  ...
  const audioTracks = useTracks([import_livekit_client17.Track.Source.Microphone]);
  useWarnAboutMissingStyles();
