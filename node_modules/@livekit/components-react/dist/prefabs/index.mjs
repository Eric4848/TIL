...
import { Track as Track2, createAudioAnalyser } from "livekit-client";
import {
  isTrackReference
} from "@livekit/components-core";
...
var useMultibandTrackVolume = (trackOrTrackReference, options = {}) => {
  var _a;
  const track = trackOrTrackReference instanceof Track2 ? trackOrTrackReference : (_a = trackOrTrackReference == null ? void 0 : trackOrTrackReference.publication) == null ? void 0 : _a.track;
...
function RoomAudioRenderer({ volume, muted }) {
  const tracks = useTracks(
    [Track5.Source.Microphone, Track5.Source.ScreenShareAudio, Track5.Source.Unknown],
    {
      updateOnlyOn: [],
      onlySubscribed: false
    }
  ).filter((ref) => !isLocal2(ref.participant) && ref.publication.kind === Track5.Kind.Audio);
  React77.useEffect(() => {
...
import { RoomEvent as RoomEvent2, Track as Track8 } from "livekit-client";
...
function ControlBar(_a) {
  ...
  return /* @__PURE__ */ React88.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React88.createElement(
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React88.createElement(TrackToggle, { source: Track7.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React88.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React88.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
    ...
    TrackToggle,
    {
      source: Track7.Source.ScreenShare,
...
function VideoConference(_a) {
  ...
  const tracks = useTracks(
    [
      { source: Track8.Source.Camera, withPlaceholder: true },
      { source: Track8.Source.ScreenShare, withPlaceholder: false }
    ],
  ...
  const screenShareTracks = tracks.filter(isTrackReference5).filter((track) => track.publication.source === Track8.Source.ScreenShare);
...
function AudioConference(_a) {
  ...
  const audioTracks = useTracks([Track9.Source.Microphone]);
  useWarnAboutMissingStyles();
