...
function useTrackRefBySourceOrName(source) {
  var _a, _b;
  const [publication, setPublication] = React43.useState(getTrackByIdentifier(source));
  ...
  return {
    ...
    source: (_b = source.source) != null ? _b : Track2.Source.Unknown,
    publication
  };
}
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a;
  const [publication, setPublication] = React82.useState(getTrackByIdentifier2(observerOptions));
...
function ParticipantTile(_a) {
  ...
  return /* @__PURE__ */ React85.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React85.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React85.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React85.createElement(React85.Fragment, null, isTrackReference3(trackReference) && (((_b2 = trackReference.publication) == null ? void 0 : _b2.kind) === "video" || trackReference.source === Track5.Source.Camera || trackReference.source === Track5.Source.ScreenShare) ? /* @__PURE__ */ React85.createElement(
    VideoTrack,
    {
      trackRef: trackReference,
  ...
  ) : isTrackReference3(trackReference) && /* @__PURE__ */ React85.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React85.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React85.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === Track5.Source.Camera ? /* @__PURE__ */ React85.createElement(React85.Fragment, null, isEncrypted && /* @__PURE__ */ React85.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React85.createElement(
    TrackMutedIndicator,
    {
      trackRef: {
...
function PreJoin(_a) {
  ...
  const [userChoices, setUserChoices] = React105.useState(defaultUserChoices);
...
import { RoomEvent as RoomEvent3, Track as Track9 } from "livekit-client";
...
function ControlBar(_a) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React109.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React109.createElement(TrackToggle, { source: Track8.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React109.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React109.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
function VideoConference(_a) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React110.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React110.createElement(
